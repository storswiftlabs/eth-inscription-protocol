...
export function ChatInput({ type }: Props) {
  ...
  useEffect(() => {
    ...
    atMember.length > 0 && setSendDataOnChain({ ...sendDataOnChain, at: atMember, image: pictureArrCid })
          ...
          <div className='flex gap-4 px-4'>
            {pictureArr.map((t, index) => {
              return <div className='relative'>
                <Image src={URL?.createObjectURL(t as any)} width={50} height={50} alt="" />
