    ...
    impl Reason {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Reason::InitialBalance => "REASON_INITIAL_BALANCE",
                Reason::Refunded => "REASON_REFUNDED",
                Reason::BuyBack => "REASON_BUY_BACK",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "REASON_INITIAL_BALANCE" => Some(Self::InitialBalance),
                "REASON_REFUNDED" => Some(Self::Refunded),
                "REASON_BUY_BACK" => Some(Self::BuyBack),
                _ => None,
            }
        }
    }
