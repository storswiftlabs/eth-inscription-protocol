...
var rootLog, _ = logging.RootLogger("firestark", "github.com/streamingfast/firehose-starknet/cmd/firestark/cli")

var RootCmd = &cobra.Command{Use: "firestark", Short: "Starknet on StreamingFast"}
...
func Main() {
	...
	derr.Check("starknet-blockchain", RootCmd.Execute())
}
