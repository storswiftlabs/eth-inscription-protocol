...
type parseCtx struct {
	currentBlock *pbstarknet.BlockData
	stats        *parsingStats
...
func newContext(logger *zap.Logger, height uint64) *parseCtx {
	return &parseCtx{
		currentBlock: &pbstarknet.BlockData{
			BlockNumber:       height,
			Transactions: []*pbstarknet.Transaction{},
		},
...
func (r *ConsoleReader) next() (out *pbstarknet.BlockData, err error) {
...
// 	trx := &pbstarknet.Transaction{
// 		Events: []*pbstarknet.Event{},
// 	}

// 	switch params[1] {
// 	case "DEPLOY":
// 		trx.Type = pbstarknet.TransactionType_DEPLOY
// 	case "INVOKE_FUNCTION":
// 		trx.Type = pbstarknet.TransactionType_INVOKE_FUNCTION
// 	case "DECLARE":
// 		trx.Type = pbstarknet.TransactionType_DECLARE
// 	case "L1_HANDLER":
// 		trx.Type = pbstarknet.TransactionType_L1_HANDLER
// 	case "DEPLOY_ACCOUNT":
// 		trx.Type = pbstarknet.TransactionType_DEPLOY_ACCOUNT
// 	default:
...
// 	trx.Events = append(trx.Events, &pbstarknet.Event{
// 		FromAddr: fromAddr,
// 		Keys:     [][]byte{},
// 		Data:     [][]byte{},
// 	})
...
// func (ctx *parseCtx) readBlockEnd(params []string) (*pbstarknet.Block, error) {
