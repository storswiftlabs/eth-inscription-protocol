...
#[derive(Clone, PartialEq, ::prost::Message)]
    pub struct TransactionReceipt {
        ...
        pub execution_resources: ::core::option::Option<transaction_receipt::ExecutionResources>,
        #[prost(message, optional, tag="4")]
        pub l1_to_l2_consumed_message: ::core::option::Option<transaction_receipt::L1ToL2Message>,
        #[prost(message, repeated, tag="5")]
        pub l2_to_l1_messages: ::prost::alloc::vec::Vec<transaction_receipt::L2ToL1Message>,
        #[prost(string, tag="6")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
        pub struct ExecutionResources {
            ...
            pub builtin_instance_counter: ::core::option::Option<execution_resources::BuiltinInstanceCounter>,
            #[prost(uint64, tag="2")]
            pub n_steps: u64,
            #[prost(uint64, tag="3")]
